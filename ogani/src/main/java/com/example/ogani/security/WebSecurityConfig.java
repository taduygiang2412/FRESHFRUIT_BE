...
@Configuration
@EnableGlobalMethodSecurity(prePostEnabled = true) // truoc khi no duocw bat security len thi no phai bang true
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
      http.cors().and().csrf().disable()// chong tan cong xac thuc khi gui request
